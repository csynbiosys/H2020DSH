...
kinetics_state1(4).p.p_tetr = 1:1:20;
kinetics_state1(4).p.p_atc = 0.1:1:10;
kinetics_state1(4).p.n_atc = 1:2;
kinetics_state1(4).p.n_tetr = 1:2;


kinetics_state1(5).formula = @(x,u,p) 1./(1+((x(:,1)./p.p_tetr).*(1./1+(u(:,1)./p.p_atc).^p.n_atc)).^p.n_tetr);
kinetics_state1(5).name = 'hill(hill)';
kinetics_state1(5).p.p_tetr = 1:1:20;
kinetics_state1(5).p.p_atc = 0.1:1:10;
kinetics_state1(5).p.n_atc = 1:2;
kinetics_state1(5).p.n_tetr = 1:2;
...
kinetics_state2(4).p.p_tetr = 1:10:100;
kinetics_state2(4).p.p_atc = 0.1:1:10;
kinetics_state2(4).p.n_atc = 1:2;
kinetics_state2(4).p.n_tetr = 1:2;


kinetics_state2(5).formula = @(x,u,p) 1./(1+((x(:,1)./p.p_tetr).*(1./1+(u(:,1)./p.p_atc).^p.n_atc)).^p.n_tetr);
kinetics_state2(5).name = 'hill(hill)';
kinetics_state2(5).p.p_tetr = 1:10:100;
kinetics_state2(5).p.p_atc = 0.1:1:10;
kinetics_state2(5).p.n_atc = 1:2;
kinetics_state2(5).p.n_tetr = 1:2;
