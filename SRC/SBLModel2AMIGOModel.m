...
% end
SBL_workdir;
AMIGOModel.odes_file=[fullfile(SBL_work_dir,'Models/AutoGeneratedC/') model_name '.c'];
AMIGOModel.mexfile=[fullfile(SBL_work_dir,'Models/AutoGeneratedC/') model_name 'CostMex'];
