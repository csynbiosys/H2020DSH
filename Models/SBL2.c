...
#define	p2_365  (*amigo_model).pars[6]
#define	p2_419  (*amigo_model).pars[7]
#define	p2_469  (*amigo_model).pars[8]
...
int amigoRHS(realtype t, N_Vector y, N_Vector ydot, void *data){
	...
	dRFP=p1_2*RFP+p1_727*1/(1+pow((RFP/19)*(1/(1+pow(U_IPTG/0.1,2))),2))+p1_767*1/(1+pow((RFP/20)*(1/(1+pow(U_IPTG/0.1,2))),2))+p1_1573*1/(1+pow((GFP/20)*(1/(1+pow(U_ATC/2.1,1))),2));
