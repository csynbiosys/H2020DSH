...
#define	p1_1430 (*amigo_model).pars[1]
#define	p2_2    (*amigo_model).pars[2]
#define	p2_407  (*amigo_model).pars[3]
...
int amigoRHS(realtype t, N_Vector y, N_Vector ydot, void *data){
	...
	dRFP=p1_2*RFP+p1_1430*1/(1+pow((GFP/16)*(1/(1+pow(U_ATC/6.1,2))),1));
	dGFP=p2_2*RFP+p2_407*1/(1+pow((GFP/1)*(1/(1+pow(U_ATC/0.1,2))),2));
